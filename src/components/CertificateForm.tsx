...
const CertificateForm = () => {
  ...
  const referenceDisplay = useMemo(() => (
    <Card className="bg-gradient-to-r from-green-50 via-emerald-50 to-blue-50 dark:from-green-950 dark:via-emerald-950 dark:to-blue-950 border-green-200 dark:border-green-700 transition-all duration-300 shadow-lg">
      <CardContent className="pt-6 pb-6">
        <div className="flex items-center gap-2 mb-4">
          <Sparkles className="w-5 h-5 text-green-600" />
          <h3 className="font-semibold text-green-800 dark:text-green-200">Auto-Generated References</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white/70 dark:bg-gray-800/70 rounded-xl backdrop-blur-sm transition-all duration-200 hover:bg-white/90 dark:hover:bg-gray-800/90 shadow-sm">
            <Label className="text-xs font-medium text-green-700 dark:text-green-300">Our Reference</Label>
            <p className="font-mono text-sm font-bold mt-2 text-green-800 dark:text-green-200">{autoGeneratedRefs.ourRef || "Loading..."}</p>
          </div>
          <div className="text-center p-4 bg-white/70 dark:bg-gray-800/70 rounded-xl backdrop-blur-sm transition-all duration-200 hover:bg-white/90 dark:hover:bg-gray-800/90 shadow-sm">
            <Label className="text-xs font-medium text-blue-700 dark:text-blue-300">Your Reference</Label>
            <p className="font-mono text-sm font-bold mt-2 text-blue-800 dark:text-blue-200">{autoGeneratedRefs.yourRef || "Loading..."}</p>
          </div>
          <div className="text-center p-4 bg-white/70 dark:bg-gray-800/70 rounded-xl backdrop-blur-sm transition-all duration-200 hover:bg-white/90 dark:hover:bg-gray-800/90 shadow-sm">
            <Label className="text-xs font-medium text-purple-700 dark:text-purple-300">Certificate Number</Label>
            <p className="font-mono text-sm font-bold mt-2 text-purple-800 dark:text-purple-200">{autoGeneratedRefs.certificateNumber || "Loading..."}</p>
          </div>
        </div>
      </CardContent>
    </Card>
